 ...
 * --- Generated at Dec 13, 2018 7:32:59 AM                     ---
 * ----------------------------------------------------------------
 *  
 * [y] hybris Platform
 *  
...
public class VariantTypeModel extends ComposedTypeModel
{
	...
	{
		if( value == null || value instanceof ComposedTypeModel)
		{
			super.setSuperType(value);
		}
		else
		{
			throw new IllegalArgumentException("Given value is not instance of de.hybris.platform.core.model.type.ComposedTypeModel");
		}
	}
