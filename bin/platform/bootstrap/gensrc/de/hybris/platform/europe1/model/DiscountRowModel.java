...
public class DiscountRowModel extends AbstractDiscountRowModel
{
	...
	{
		if( value == null || value instanceof ProductModel)
		{
			super.setProduct(value);
		}
		else
		{
			throw new IllegalArgumentException("Given value is not instance of de.hybris.platform.core.model.product.ProductModel");
		}
	}
