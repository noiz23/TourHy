		...
		try
		{
			...
			sessionService.executeInLocalView(new SessionExecutionBody()
			{
				...
				public void executeWithoutResult()
				{
					...
					final SearchRestrictionModel createdActiveRestriction = createRestriction(user, composedTypeModel,
							"TitleRestrictionActive", "{name} in (?session.names)", Boolean.TRUE);
