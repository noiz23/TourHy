...
/**
 * This is the extension manager of the Concerttours extension.
 */
public class ConcerttoursManager extends GeneratedConcerttoursManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(ConcerttoursManager.class);
	 ...
	 */
	public static ConcerttoursManager getInstance()
	{
		return (ConcerttoursManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(ConcerttoursConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ConcerttoursManager() // NOPMD 
	{
		LOG.debug("constructor of ConcerttoursManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of ConcerttoursManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of ConcerttoursManager called, current tenant: {}", getTenant().getTenantID());
	}
